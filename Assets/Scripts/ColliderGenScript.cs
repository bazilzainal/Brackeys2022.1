...
public class ColliderGenScript : MonoBehaviour
{
    ...
    private Transform deathCollider;
    ...
    void Start()
    {
        ...
        deathCollider = new GameObject().transform;
        ...
        deathCollider.parent = transform;
        ...
        deathCollider.localScale = new Vector3(colDepth, screenSize.y * 2, colDepth);
        deathCollider.position = new Vector3(cameraPos.x - screenSize.x - (leftCollider.localScale.x * 0.5f) - 1f, cameraPos.y, zPosition);
    }
